  ...
  {
    {
      ...
      /*  3 */ {KC_E,    KC_4,   KC_PAST, KC_F12,  KC_QUOT, KC_SYSTEM_POWER,   KC_LCTL, KC_MS_RIGHT},
      ...
      /*  9 */ {KC_B,    KC_1,   KC_P8,   KC_F9,   KC_DOT,  KC_AUDIO_VOL_DOWN, KC_SPC,  KC_MS_WH_UP},
      /*  A */ {KC_NLCK, KC_ESC, KC_I,    KC_8,    KC_NO,   KC_NO,             KC_X,    KC_END},
      /*  B */ {KC_A,    KC_GRV, KC_P7,   KC_F8,   KC_SLSH, KC_AUDIO_VOL_UP,   KC_RALT, KC_MS_WH_RIGHT},
      ...
      /*  F */ {KC_C,    KC_2,   KC_P9,   KC_F10,  KC_COMM, KC_AUDIO_MUTE,     KC_LALT, KC_MS_WH_DOWN}
    }
    ,
    {
      /*          0     1     2     3     4     5     6     7   */
